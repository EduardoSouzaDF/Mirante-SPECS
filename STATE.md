...
- Spec ativa: 0005 — Incluir Lançamento
...
- Próxima ação sugerida: implementar backend (ContaCorrente, Lancamento, ajustar Lote para não expor valor/quantidadeLancamentos)

## Histórico de retomada

- 2026-09-13 — spec 0005 iniciada (Incluir Lançamento); spec/plan/tasks/tests preenchidos junto com o usuário; mudança de modelo definida: valor/quantidadeLancamentos do lote passam a ser calculados no frontend a partir de `lancamentos` (não mais campos próprios do backend); branch feature/0005-incluir-lancamento criada nos 3 repos a partir do estado atual (feature/0004, ainda não mesclada em main)
